...
export default async function DashboardPage() {
    ...
    await Promise.all([
      ...
      prisma.contract.count({
        where: {
          ...
          endDate: { gte: new Date(), lte: new Date(Date.now() + 90 * 86400000) },
        },
      }),
    ]);
  ...
  const quickLinks = [
    ...
    { label: "สัญญาทั้งหมด", desc: `${activeContracts} รายการ active`, href: "/contracts", icon: "📄", color: "#059669" },
    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .breadcrumb-cur { font-size: 14px; font-weight: 600; color: #1E293B; }
        .topbar-search {
        ...
        .topbar-search:focus-within { border-color: #D41E28; }
        .topbar-search input {
        ...
        .page-date { font-size: 13px; color: #94A3B8; margin-top: 3px; }
        ...
        .alert-btn {
          background: #F59E0B; color: white; border: none; padding: 7px 16px;
        ...
        .ql-item {
          display: flex; align-items: center; gap: 12px;
          padding: 13px 14px; border-radius: 10px; border: 1.5px solid #F1F5F9;
        ...
        .status-key { font-size: 13px; color: #475569; }
        .status-val { font-size: 13px; font-weight: 700; }

        /* ── ACCOUNTS ── */
        .acc-table { width: 100%; border-collapse: collapse; }
        .acc-table th { font-size: 11px; font-weight: 600; color: #94A3B8; text-transform: uppercase; letter-spacing: 0.8px; padding: 0 0 10px; text-align: left; border-bottom: 1px solid #F1F5F9; }
          ...
          <div className="sidebar-footer">
            <div className="sidebar-user">
              ...
              <div>
                ...
                <div className="sidebar-user-role">admin@itas.co.th</div>
              </div>
            </div>
          </div>
        </aside>
        ...
        <div className="main-area">
          ...
          <header className="topbar">
            <div className="topbar-left">
              <span className="breadcrumb">iTAS BackOffice&nbsp;/&nbsp;</span>
              <span className="breadcrumb-cur">Dashboard</span>
            </div>

            <form method="GET" action="/search" className="topbar-search">
            ...
            <div className="topbar-right">
              ...
              <div style={{ width: 36, height: 36, borderRadius: "50%", background: "linear-gradient(135deg,#D41E28,#ef4444)", display: "flex", alignItems: "center", justifyContent: "center", color: "white", fontWeight: 700, fontSize: 14, boxShadow: "0 2px 8px rgba(212,30,40,0.35)" }}>A</div>
            </div>
          </header>
            ...
            <div className="two-col">
              ...
              <div>
                <div className="card">
                  <div className="card-title">
                    ⚡ Quick Access
                    <span className="card-title-badge">6 modules</span>
                  </div>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
                ...
                <div className="card">
                  ...
                  {[
                    { key: "Database", val: "Connected", dot: "#10B981", valColor: "#059669" },
                    { key: "Active Contracts", val: `${activeContracts} รายการ`, dot: "#3B82F6", valColor: "#2563EB" },
                    { key: "Total Assets", val: `${totalAssets} รายการ`, dot: "#8B5CF6", valColor: "#7C3AED" },
                    { key: "Customers", val: `${totalCustomers} ราย`, dot: "#10B981", valColor: "#059669" },
                    { key: "Expiring (90d)", val: `${expiringAssets} รายการ`, dot: expiringAssets > 0 ? "#F59E0B" : "#10B981", valColor: expiringAssets > 0 ? "#D97706" : "#059669" },
                    { key: "Contracts Expiring", val: `${expiringContracts} รายการ`, dot: expiringContracts > 0 ? "#EF4444" : "#10B981", valColor: expiringContracts > 0 ? "#DC2626" : "#059669" },
                  ].map((s) => (
                    <div key={s.key} className="status-row">
                      <div className="status-row-left">
                        <div className="status-dot" style={{ background: s.dot }} />
                        <span className="status-key">{s.key}</span>
                      </div>
                      <span className="status-val" style={{ color: s.valColor }}>{s.val}</span>
                    </div>
                  ))}
                </div>
